...
//
        ...
        if ("tableCellEditor".equals(e.getPropertyName())) {
            ...
            //SwingUtilities.invokeLater( this );
            {
                try {
                    ...
                    Logger.getLogger(TableCellListener.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void processEditingStopped() throws ClassNotFoundException, SQLException, IOException, Exception {
        ...
        Tretman t = new Tretman(IDtretmana);
        t.setOpis((String) table.getModel().getValueAt(row, 1));
